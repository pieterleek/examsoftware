...
if ($userCount === 0 || $nameCount === 0) {
    http_response_code(500);
    exit('Kon studentgegevens niet in login.php verwerken. Controleer het template.');
}

$hashComment = "\n// Laat deze regel staan, anders krijg je een onvoldoende!: $hash\n";
